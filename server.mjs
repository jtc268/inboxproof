...
async function requestHandler(req, res) {
  ...
  try {
    ...
    if (req.method === 'GET' && /^\/r\/[a-f0-9-]{36}$/.test(u.pathname)) {
      ...
      let extra;
      if (rep && rep.domain) {
        extra = '<meta property="og:title" content="' + esc('Configuration report: ' + rep.domain + ' scored ' + rep.score + '/100') + '" />\n'
          + '<meta property="og:description" content="' + esc('Inboxproof audited ' + rep.domain + ' and scored it ' + rep.score + '/100 (' + rep.grade + '). Review DNS and mail-server observations, limitations and next steps.') + '" />\n'
          + '<meta property="og:type" content="website" />\n<meta name="twitter:card" content="summary_large_image" />\n';
      } else {
        extra = '<meta property="og:title" content="Inboxproof configuration report" />\n'
          + '<meta property="og:description" content="Public email configuration report generated by Inboxproof." />\n'
          + '<meta property="og:type" content="website" />\n<meta name="twitter:card" content="summary_large_image" />\n';
      }
